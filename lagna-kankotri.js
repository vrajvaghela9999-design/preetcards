...
const renderCards = (cards) => {
    ...
    cards.forEach(card => {
        ...
        cardEl.className = 'images/card-item-3d';
        ...
        const ctaButton = card.tier === 'mid' ? `
            <a href="https://wa.me/919824319135?text=${whatsappMsg}" 
               class="images/card-cta-btn" target="_blank" rel="noopener noreferrer">
        ...
        cardEl.innerHTML = `
            <div class="images/card-inner-3d">
                <div class="images/card-front-3d">
                    <img src="${card.image}" alt="${altText}" loading="lazy">
                    <span class="images/card-category-badge">${card.category}</span>
                    <span class="images/card-tier-badge tier-${card.tier}">${tierBadge}</span>
                    <span class="images/card-code-badge">Code: ${card.code}</span>
                </div>
                <div class="images/card-back-3d">
                    <span class="images/card-code-back">Code: ${card.code}</span>
                    <h3>${card.name}</h3>
